...
function withAuth(
  ...
  class App extends React.Component {
    ...
    componentDidMount() {
      console.log('Executing (withAuth) componentDidMount()');
      ...
      // redirect to "/" page
      if (logoutRequired && user && !adminRequired) {
        Router.push('/');
      }
      console.log('Finished Executing (withAuth) componentDidMount()');
    }
    ...
    static async getInitialProps(ctx) {
       ...
       * */
      console.log('Executing (withAuth) getInitialProps()');
